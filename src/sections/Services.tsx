...
export default function Services() {
  ...
  const { ref: metamorficaRef, isVisible: metamorficaVisible } = useInView({ threshold: 0.2 });
  ...
  return (
    <section id='services' className="scroll-mt-28 lg:scroll-mt-37 mt-28 lg:mt-37 flex flex-col gap-8">
      ...
      <div className='w-full flex flex-col md:flex-row justify-start items-center gap-8'>
        <div
          ref={soulRef}
          className={`w-[80%] md:w-[30%] ml-[-20%] md:m-0 h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${soulVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 10%, rgba(0,0,0,0) 40%), url(${soul})` }}
        >
          <p>{t('sections.services.soul')}</p>
        </div>

        <div
          ref={essenzaRef}
          className={`w-[80%] md:w-[30%] h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${essenzaVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 40%), url(${essenza})` }}
        >
          <p>{t('sections.services.essenza')}</p>
        </div>

        <div
          ref={vitaRef}
          className={`w-[80%] md:w-[30%] ml-[20%] md:m-0 h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${vitaVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 40%), url(${vita})` }}
        >
          {t('sections.services.vita')}
        </div>
      </div>
      ...
      <div className='w-full flex flex-col md:flex-row justify-end items-center gap-8'>
        <div
          ref={metamorficaRef}
          className={`w-[80%] md:w-[30%] h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${metamorficaVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 40%), url(${metamorfica})` }}
        >
          {t('sections.services.metamorfica')}
        </div>

        <div
          ref={alberoRef}
          className={`w-[80%] md:w-[30%] ml-[-20%] md:ml-0 h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${alberoVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 40%), url(${albero})` }}
        >
          {t('sections.services.albero')}
        </div>

        <div
          ref={riflexRef}
          className={`w-[80%] md:w-[30%] h-80 rounded-3xl bg-center bg-cover flex flex-col items-center justify-end text-white text-2xl p-4 ${riflexVisible ? 'fade-in-right' : 'fade-hidden'}`}
          style={{ backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 40%), url(${riflex})` }}
        >
          {t('sections.services.riflex')}
        </div>
      </div>
    </section>
  );

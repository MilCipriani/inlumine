...
export default function FounderQuote() {
  ...
  return (
    <section className="flex flex-col-reverse md-plus:flex-row w-full items-center justify-center mt-28 lg:mt-37 rounded-3xl bg-white max-h-[100vh]">
      <div className='md-plus:h-96 w-full flex flex-col-reverse md-plus:flex-row items-center justify-center rounded-3xl bg-white'>
        <img src={treeImg} alt={t('sections.founderQuote.alt')} className='h-full w-full md-plus:max-w-[45%] object-cover rounded-b-3xl md-plus:rounded-none md-plus:rounded-l-3xl'/>
        <div className='p-8 sm:p-24 md:p-16 md-plus:p-8 flex flex-col items-center justify-center gap-8'>
          ...
          <p className='text-[var(--feather-blue)] text-center'>{t('sections.founderQuote.p')}</p>
        </div>
      </div>

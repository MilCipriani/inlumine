  ...
  return (
    <div className="flex flex-col bg-white rounded-3xl h-full">
      ...
      <div className="flex flex-col p-4 gap-4 h-full">
        ...
        {card.website && (
          <a href={card.website} className="bg-[var(--feather-blue)] rounded-2xl w-fit ml-auto mt-auto hover:bg-[var(--blue-highlight)]" target="_blank" rel="noopener noreferrer"><Arrow className="w-12 h-12 text-white"/></a>
        )}
      </div>
    </div>
  );
